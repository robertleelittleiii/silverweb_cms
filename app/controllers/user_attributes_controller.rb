class UserAttributesController < ApplicationController
  ...
  def user_attribute_params
    ...
    params[:user_attribute].permit("first_name", "last_name", "handle", "birthdate", "user_id", "phone_number",SilverwebCms::Config.USER_ATTRIBUTE_PERMITTED_FIELDS)
    # params[:user_attribute].permit()
