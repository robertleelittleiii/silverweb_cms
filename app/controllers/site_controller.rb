class SiteController < ApplicationController
  ...
  def index
    ...
    @page = ((Page.find_by_id(params[:id]) || Page.find_by_title(params[:page_name]) || (params[:page_name].blank? ? nil : Page.where('lower(title) = ?', params[:page_name].gsub("_"," ").gsub("-"," ").downcase).first) || Page.find_by_slug(params[:page_name])) || Page.find_by_title(Settings.home_page_name) || Page.find_by_title("Home")) || Page.new(:title=>"'Home' not found.", :body=>"'Home' not found.")   
  ...
  def show_page_popup
    ...
    @page = ((Page.find(params[:id]) rescue Page.find_by_title(params[:page_name])) rescue Page.find_by_title("Home")) rescue "'Home' not found."
