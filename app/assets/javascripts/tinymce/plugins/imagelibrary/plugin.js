...
tinymce.PluginManager.add('imagelibrary', function(editor,url) {
	...
	editor.addButton('imagelibrary', {
		icon: 'image',
		tooltip: 'Insert/edit image from library',
		onclick: createImageList(showDialog),
		stateSelector: 'img:not([data-mce-object],[data-mce-placeholder])'
	});

	editor.addMenuItem('imagelibrary', {
		icon: 'image',
	...
	editor.addCommand('mceImageLib', createImageList(showDialog));
});
